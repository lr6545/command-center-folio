    ...
    <section className="py-24 relative">
      <div className="container px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary via-secondary to-muted md:-translate-x-px" />
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute left-0 md:left-1/2 w-8 h-8 rounded-full bg-card border-2 border-primary flex items-center justify-center md:-translate-x-1/2 z-10"
                >
                  <div className="w-3 h-3 rounded-full bg-primary" />
                </motion.div>

                {/* Content Card */}
                <div className={`pl-12 md:pl-0 md:w-[calc(50%-2rem)] ${isEven ? "" : "md:ml-auto"}`}>
                  <GlassCard className="p-6" delay={index * 0.15}>
                    {/* Duration */}
                    ...
                    <ul className="space-y-2">
                      {exp.achievements.map((achievement, achIndex) => (
                        <motion.li
                          ...
                          viewport={{ once: true }}
                          transition={{ delay: index * 0.15 + achIndex * 0.05 + 0.2 }}
